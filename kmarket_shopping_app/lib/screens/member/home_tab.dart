    ...
    return Column(
      children: [
        Padding(
            ...
            child: Text('베스트 상품', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
        ),
        SizedBox(
          height: 200,
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        height: 140,
                        color: Colors.grey,
                        child: Image.asset('images/sampler_thumb.jpg'),
                      ),
                      Text('가을 티셔츠'),
                      Text('16,000원'),
                    ],
  ...
  Widget _buildFooter(BuildContext context){
    return Container(
      ...
      child: Column(
        children: [
          Text('회사 정보 및 약관'),
          Text('고객센터 : 000-0000-0000', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold),),
          Text('Kmarket Shopping App. ALL ')
        ],
      ),
    );
  }
